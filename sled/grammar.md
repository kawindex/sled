...
concrete
    ...
    integer
    float
    "@hex" optional_ws '(' optional_hex_digits ')'
    "@true"
    "@false"
    "@nil"
...
float
    ...
    integer exponent
    optional_sign optional_digits decimal_mark optional_digits digit optional_digits optional_exponent

integer
    optional_sign optional_digits digit optional_digits
...
optional_hex_digits
    optional_ws
    optional_ws hex_digit optional_hex_digits
...
exponent
    exponent_marker optional_digits digit optional_digits
