...
HEX_DIGIT_SET = frozenset(string.hexdigits)
HEX_DIGIT_WITH_SEPARATOR_SET = HEX_DIGIT_SET.union(_DIGIT_SEPARATOR_TUP)
HEX_DIGIT_HORIZONTAL_SET = HEX_DIGIT_WITH_SEPARATOR_SET.union(HORIZONTAL_SPACE_SET)
